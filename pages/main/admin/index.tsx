...
export async function getServerSideProps(context: any) {
    try {
        ...
        const result = await axios.get(CONFIG.base_url_api + `/admins?pagination=true&search=${search || ""}&page=${page || 0}`, {
...
export default function Admin({ table }: any) {
    ...
    const save = async (e: any) => {
        ...
        try {
            ...
            const result = await axios.post(CONFIG.base_url_api + '/admin', payload, {
                headers: { "bearer-token": 'bengkelsehati51' }
            })
            Swal.fire({
